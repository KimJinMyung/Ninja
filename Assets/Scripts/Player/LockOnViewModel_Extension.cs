...
public static class LockOnViewModel_Extension
{
    ...
    public static void RequestLockOnTarget(this LockOnZoneViewModel model, Transform target, InputViewModel player)
    {
        ActorLogicManager._instance.OnLockOnTarget(target, player);
    }

    public static void OnResponseLockOnTargetChangedEvent(this LockOnZoneViewModel model, Transform target, InputViewModel player)
    {        
